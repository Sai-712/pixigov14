        ...
        <div className="relative min-h-screen bg-red-100">
            <div className="container mx-auto px-4 py-8 relative z-10">
                <div className="mb-8 flex flex-col sm:flex-row justify-center items-start sm:items-center gap-4">
                    <h1 className="text-3xl font-bold text-red-600">Upload Images</h1>
                </div>
            {/* Video Background */}
            <video
                autoPlay
                ...
                <div className="max-w-2xl mx-auto bg-black p-8 rounded-lg shadow-md border-4 border-aquamarine">
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex items-center gap-4">
                            <select
                                ...
                                className="border border-red-300 rounded-lg px-4 py-2 min-w-[200px]"
                            >
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-center w-full">
                            <label htmlFor="file-upload" className="w-full flex flex-col items-center px-4 py-6 bg-red-100 rounded-lg border-2 border-turquoise border-dashed cursor-pointer hover:border-aquamarine hover:bg-champagne transition-colors duration-200">
                        ...
                        {images.length > 0 && (
                            <div className="mt-4">
                                <p className="text-sm text-red-600 mb-2">{images.length} file(s) selected</p>
                                        ...
                                        <div key={index} className="relative group">
                                            ...
                                            <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-200 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
                                                <button
                                                    ...
                                                    className="p-2 bg-red-100 rounded-full hover:bg-gray-100 transition-colors duration-200"
                    ...
                    {showQRModal && (
                        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                            <div className="bg-red-300 rounded-lg p-6 max-w-sm w-full">
                                ...
                                <div className="flex flex-col items-center space-y-4">
                                    <p className="text-sm text-red-700 mb-2">Share this QR code or link with others to let them find their photos</p>
                                    ...
                                    <div className="w-full">
                                        <div className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                                            ...
                                            <button
                                                onClick={() => {
                                                    navigator.clipboard.writeText(`${window.location.origin}/upload-selfie?eventId=${selectedEvent}`);
                                                    setShowCopySuccess(true);
                                                    setTimeout(() => setShowCopySuccess(false), 2000);
                                                }}
                                                className="px-3 py-1 bg-turquoise text-red-300 rounded hover:bg-aquamarine transition-colors"
                                            >
                                                Copy
                                            </button>
                                        </div>
                                    ...
                                    <div className="flex gap-2 w-full">
                                        <button
                                            ...
                                            className="flex-1 bg-black text-white py-2 px-4 rounded-lg hover:bg-red-700 transition-colors duration-200 flex items-center justify-center"
                                        >
                                            <Download className="w-5 h-5 mr-2" />
                                            Download QR
                                        </button>
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-aquamarine text-black py-2 px-4 rounded-lg hover:bg-red-600 transition-colors duration-200 flex items-center justify-center"
                                    >
