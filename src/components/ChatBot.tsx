  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
          ...
          >
            ...
            <div className="h-96 p-4 overflow-y-auto flex flex-col space-y-4">
              {messages.map((message, index) => (
                ...
                >
                  <div
                    className={`max-w-[80%] rounded-lg p-3 ${message.isUser ? 'bg-red-500 text-white' : 'bg-gray-100 text-gray-800'}`}
                  >
                    {message.text}
                  </div>
                </div>
            ...
            <div className="p-4 border-t">
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="bg-red-500 text-white rounded-lg px-4 py-2 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500"
                >
                  Send
                </button>
              </div>
      ...
      <motion.button
        ...
        className="bg-red-500 text-white rounded-full p-4 shadow-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500"
      >
