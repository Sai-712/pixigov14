          ...
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <div className="relative">
                <div className="mb-6 flex h-[200px] w-[300px] items-center justify-center rounded-2xl bg-white p-4 shadow-lg ring-1 ring-gray-900/10">
                  <img
                    src={step.image}
                    alt={step.title}
                ...
                <div className="absolute -left-4 -top-4 flex h-8 w-8 items-center justify-center rounded-full bg-red-500 text-white">
                  {index + 1}
                </div>
              </div>
